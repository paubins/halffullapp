...
DATABASES = {
    'default': {
        ...
        'NAME': 'halffull',                      # Or path to database file if using sqlite3.
        'USER': 'halffull',                      # Not used with sqlite3.
        'PASSWORD': 'halffull',                  # Not used with sqlite3.
...
STATIC_ROOT = '/home/halffull/static/'
